          ...
          <div className="grid-2">
            ...
            <div>
              <div style={{ display: 'flex', flexDirection: 'column', gap: '1rem', marginTop: '1rem' }}>
                <p style={{ fontFamily: 'var(--font-body)', color: 'rgba(255,255,255,0.5)', lineHeight: 1.75 }}>Investors can acquire vehicles and have them operated by professional drivers while SHUGA Empire HoldCo helps coordinate and manage the operational side — from vehicle deployment to driver management and performance oversight.</p>
