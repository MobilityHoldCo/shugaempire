...
export const metadata: Metadata = {
  title: 'About Us',
  description: 'SHUGA Empire HoldCo was built around a simple observation: Nigeria doesn\'t just need more vehicles. Nigeria needs better mobility systems.',
};
      ...
      <section className="section section--dark" style={{ paddingTop: '10rem' }}>
        <div className="container">
          ...
          <p className="lead" style={{ marginTop: '2rem' }}>
            SHUGA Empire HoldCo was built around a simple observation: Nigeria doesn&apos;t just need more vehicles. Nigeria needs better mobility systems.
          </p>
        </div>
      </section>
        ...
        <div className="container">
          <div className="grid-2">
            <div>
              ...
              <RevealText as="h2" className="heading-lg">That&apos;s SHUGA Empire HoldCo.</RevealText>
            </div>
            <div>
